...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { owner_id_id: @piece.owner_id_id, piecetype: @piece.piecetype, points: @piece.points, teamcolor: @piece.teamcolor } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { owner_id_id: @piece.owner_id_id, piecetype: @piece.piecetype, points: @piece.points, teamcolor: @piece.teamcolor } }
